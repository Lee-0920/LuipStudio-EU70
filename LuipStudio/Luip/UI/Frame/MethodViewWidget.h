#ifndef METHODVIEWWIDGET_H
#define METHODVIEWWIDGET_H
...
class MethodViewWidget : public QDialog
{
    Q_OBJECT
public:
    explicit MethodViewWidget(QWidget *parent = 0);
    ~MethodViewWidget();
     static MethodViewWidget *Instance();
...
private:
    ...
    QVector<MethodRecord> m_showFields;
    ...
    static std::unique_ptr<MethodViewWidget> m_instance;
signals:
