 ...
 * @param[in] addr 设备地址。
 */
OCTemperatureControlInterface::OCTemperatureControlInterface(DscpAddress addr)
...
OCTempCalibrateFactor OCTemperatureControlInterface::GetCalibrateFactor() const
{
    OCTempCalibrateFactor factor = {0, 0, 0};
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
bool OCTemperatureControlInterface::SetCalibrateFactor(OCTempCalibrateFactor factor)
{
 ...
 */
OCTemperature OCTemperatureControlInterface::GetTemperature() const
{
    OCTemperature temp;
 ...
 */
OCThermostatParam OCTemperatureControlInterface::GetThermostatParam() const
{
    OCThermostatParam param;
    ...
    if (resp)
    {
        param = *((OCThermostatParam*)resp->data);
    }
...
* @return 返回状态，操作是否成功。
 */
bool OCTemperatureControlInterface::SetThermostatParam(OCThermostatParam param)
{
    Uint16 status = DscpStatus::Error;
...
Uint16 OCTemperatureControlInterface::GetThermostatStatus() const
{
 ...
 */
bool OCTemperatureControlInterface::StartThermostat(OCThermostatMode mode, float targetTemp, float toleranceTemp, float timeout)
{
    Uint16 status = DscpStatus::Error;
    Uint8 cmdData[13] = {0};
 ...
 * @note 该命令将立即返回。
 */
bool OCTemperatureControlInterface::StopThermostat()
{
    Uint16 status = DscpStatus::Error;
 ...
 */
bool OCTemperatureControlInterface::SetTemperatureNotifyPeriod(float period)
{
    Uint16 status = DscpStatus::Error;
 ...
 *  - @ref temp float，当前温度。
 */
OCThermostatResult OCTemperatureControlInterface::ExpectThermostat(long timeout)
{
    OCThermostatResult thermostatResult;
 ...
 */
void OCTemperatureControlInterface::RegisterTemperatureNotice(IEventReceivable *handle)
{
 ...
 */
bool OCTemperatureControlInterface::BoxFanSetOutput(float level)
{
    Uint16 status = DscpStatus::Error;
 ...
 * @param[in] level unsigned char ,风扇速率，对应高电平占空比。默认为0，机箱风扇关闭。
 */
bool OCTemperatureControlInterface::DigestionFanSetOutput(float level)
{
    Uint16 status = DscpStatus::Error;
 ...
 * @note
 */
float OCTemperatureControlInterface::GetHeaterMaxDutyCycle() const
{
 ...
 */
bool OCTemperatureControlInterface::SetHeaterMaxDutyCycle(float maxDutyCycle)
{
    Uint16 status = DscpStatus::Error;
 ...
 */
OCThermostatParam OCTemperatureControlInterface::GetCurrentThermostatParam() const
{
    OCThermostatParam param;
    memset(&param, 0, sizeof(param));
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
bool OCTemperatureControlInterface::SetCurrentThermostatParam(OCThermostatParam param)
{
    Uint16 status = DscpStatus::Error;
 ...
 * @brief 开启继电器 温控板紫外灯
 */
bool OCTemperatureControlInterface::TurnOnRays()
{
    Uint16 status = DscpStatus::Error;
 ...
 * @brief 关闭继电器 温控板紫外灯
 */
bool OCTemperatureControlInterface::TurnOffRays()
{
    Uint16 status = DscpStatus::Error;
 ...
 */
bool OCTemperatureControlInterface::BoxFanSetOutputForTOC(Uint8 index, float level)
{
    Uint16 status = DscpStatus::Error;
    Uint8 cmdData[5] = {0};
