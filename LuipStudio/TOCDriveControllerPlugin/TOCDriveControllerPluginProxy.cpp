...
OOLUA_EXPORT_FUNCTIONS(SolenoidValveInterface, GetTotalValves, GetValveMap, SetValveMap,
                       SetValveMapNormalOpen, RegisterPressureNotice)
...
OOLUA_EXPORT_FUNCTIONS(TOCDriveController, Init, Uninit, SetBoxFanEnable, GetIPeristalticPump, GetISolenoidValve,
                       ...
                       GetIExtOpticalAcquire, GetIExtTemperatureControl, Register,ClearBuf)
OOLUA_EXPORT_FUNCTIONS_CONST(TOCDriveController,GetReportThermostatTemp,GetReportEnvironmentTemp,
                             ...
                             GetPressure,NDIRResultHandle,IsReachSteady,GetScanData,GetScanLen,
